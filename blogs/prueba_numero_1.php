<?php
$titulo = "Prueba numero 1";
$descripcionImg = "imagen sin contexto del titulo";
$contenido = "<div>ahora si ya?</div>";

$descripcion = "Las demas pruebas nunca existieron, gracias";

$rutaDestino = "../img/175496196-día-de-prevención-de-desastres-naturales-con-niños-explicando-guía-de-seguridad.jpg";

$autor = "Victor Luna";
$keywords = "prueba, texto, ya";
$estado = "CDMX";
?> 
  <!DOCTYPE html>
  <html lang="en">
