<?php
$titulo = "qqqqqqqqqqqqqqqq";
$descripcionImg = "111111111111111111";
$contenido = "<div>1111111111111111111</div>";

$descripcion = "11111111111111";

$rutaDestino = "../img/Dulcero.jpg";
...
<label id="milabel" class="menu-icon-index" for="btn-menu"><i class="fas fa-bars"></i></label>
      ...
      <main class="contenedor seccion contenido-centrado">
          ...
          <br>
          "<a href="http://localhost/seo/subirBlog.php"> <?php echo ($palabra) ?></a>";
