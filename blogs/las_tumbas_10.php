<?php
$titulo = "Las tumbas 10";
$descripcionImg = "No se que era";
$contenido = "<div>Son tumbas</div>";
...
<label id="milabel" class="menu-icon-index" for="btn-menu"><i class="fas fa-bars"></i></label>
      ...
      <br>
          <center><p><?php echo nl2br($descripcionImg);  ?></center> </p>
          <br>
      ...
      <main class="contenedor seccion contenido-centrado">
          ...
          <br>
          <center><meta name= "keywords" content = "<?php echo nl2br($keywords);  ?>"><?php echo nl2br($keywords);  ?></center><br>
