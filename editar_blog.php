...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $nuevaDescripcionImg = $_POST['nueva_descripcionImg'];
    ...
    if ($row = mysqli_fetch_assoc($result)) {
        ...
        $descripcionImg = $row['descripcionImg'];
...
echo" <option value='Zacatecas'>Zacatecas</option>";
        ...
        echo "<label>Descripción:</label><textarea name='nueva_descripcionImg'  rows='8' cols='80' required>$descripcionImg</textarea><br>";
