    ...
    <main class="contenedor seccion contenido-centrado">
        ...
        <form class="contacto" action="scripts/crear_pagina.php" method="POST" enctype="multipart/form-data">
            <fieldset>
                ...
                <label for="descripcionImg">Coloca la descripción de tu imagen (Opcional): </label>
                <textarea style ="height:10rem; resize: none; " name="descripcionImg" rows="2" cols="10" required></textarea><br>
